...
#print STDERR "3. sercxvorto = $sercxvorto, $par (per sufikso)\n" if $par;
	...
	if ($sercxvorto =~ /^re/o || $sercxvorto =~ /^ek/o || $sercxvorto =~ /^fin/o || $sercxvorto =~ /^fi/o || $sercxvorto =~ /^fuŝ/o || $sercxvorto =~ /^mal/o  || $sercxvorto =~ /^pli/o || $sercxvorto =~ /^malpli/o || $sercxvorto =~ /^sub/o) {
